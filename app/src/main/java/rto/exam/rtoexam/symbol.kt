...
class   symbol : AppCompatActivity(), View.OnClickListener {

    private var mCurrentPosition: Int = 1
    private var mQuestionList: ArrayList<symolAnswer>? = null
    ...
    private lateinit var tv_question: ImageView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_symbol2)
        ...
        mQuestionList = SymConstants.getQuestions()
        setQuestion()
